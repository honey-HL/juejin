...
class MyDocument extends next_document__WEBPACK_IMPORTED_MODULE_8___default.a {
  static async getInitialProps(ctx) {
    const sheet = new styled_components__WEBPACK_IMPORTED_MODULE_9__["ServerStyleSheet"](); // 劫持原本的renderPage函数并重写
    ...
    try {
      ...
      const props = await next_document__WEBPACK_IMPORTED_MODULE_8___default.a.getInitialProps(ctx);
      return _objectSpread({}, props, {
        styles: __jsx(react__WEBPACK_IMPORTED_MODULE_7___default.a.Fragment, null, props.styles, sheet.getStyleElement())
      });
    } finally {
      sheet.seal();
    }
  ...
  render() {
    return __jsx(next_document__WEBPACK_IMPORTED_MODULE_8__["Html"], null, __jsx(next_document__WEBPACK_IMPORTED_MODULE_8__["Head"], null), __jsx("body", null, __jsx(next_document__WEBPACK_IMPORTED_MODULE_8__["Main"], null), __jsx(next_document__WEBPACK_IMPORTED_MODULE_8__["NextScript"], null), "\b"));
  }
